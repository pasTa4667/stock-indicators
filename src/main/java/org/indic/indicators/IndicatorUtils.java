...
public class IndicatorUtils {
     ...
     */
    public static OptionalDouble smaWithPeriodValues(List<Double> prices, int period) {
     ...
     * @return The ema values as list
     */
    public static List<Double> emaWithFirstPriceAsInitial(List<Double> prices, int period) {
        if(prices.size() < period) return new ArrayList<>();
